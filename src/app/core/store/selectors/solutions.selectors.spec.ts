...
describe('Solution Selectors', () => {
  ...
  describe('getSolutionEntities', () => {
    it('should get the entities', () => {
      expect(fromSelectors.getSolutionEntities(state)).toEqual(coreState.solutions.entities);
    });
  });
  ...
  describe('getSolutionById', () => {
    it('should get a Solution by id', () => {
      expect(fromSelectors.getSolutionById(1)(state)).toEqual(coreState.solutions.entities[1]);
    });
  ...
  describe('getSolutionsByAssetId', () => {
    it('should get a Solution by its Asset id', () => {
      expect(fromSelectors.getSolutionsByAssetId(1)(state)).toEqual([coreState.solutions.entities[1]]);
    });
